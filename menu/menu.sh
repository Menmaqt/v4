...
4) clear ; menu-trgo ;;
5) clear ; menu-trojan ;;
6) clear ; wget https://raw.githubusercontent.com/Menmaqt/v4/main/update.sh && chmod +x update.sh && ./update.sh ;;
7) clear ; status ;;
8) clear ; restarts ;;
9) clear ; menu-backup ;;
10) clear ; passwd ;;
11) clear ; menu-set ;;
12) clear ;  wget https://raw.githubusercontent.com/Menmaqt/v4/main/up.sh && chmod +x up.sh && ./up.sh  ;;
0) clear ; menu ;;
x) exit ;;
